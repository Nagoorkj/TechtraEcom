...
session_start();
error_reporting(0);
include('includes/vendor-config.php');
...
if(isset($_POST['submit']))
{
	...
	//to do the registration for vendor user
$name=$_POST['fullname'];
$email=$_POST['emailid'];
...
if($num>0)
{
$extra="client-login/change-password.php";
